...
set NN_CLASSPATH=%NN_CLASSPATH%;%NEIGHBORNOTE%lib\evernote-api-1.25.0.jar
set NN_CLASSPATH=%NN_CLASSPATH%;%NEIGHBORNOTE%lib\h2-1.3.163.jar
set NN_CLASSPATH=%NN_CLASSPATH%;%NEIGHBORNOTE%lib\h2-lucene-ex-1.3.163.jar
...
set NN_CLASSPATH=%NN_CLASSPATH%;%NEIGHBORNOTE%lib\lucene-analyzers-3.6.2.jar
set NN_CLASSPATH=%NN_CLASSPATH%;%NEIGHBORNOTE%lib\lucene-core-3.6.2.jar
